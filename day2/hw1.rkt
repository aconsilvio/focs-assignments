...
;;; [x] I completed this assignment with David Abrahams (mostly brainstorming and debugging with each other).  
;;;     We used the racket docs and the Scheme in one page resource.
